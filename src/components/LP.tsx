      ...
      <section className="relative overflow-hidden border-b">
        <div className="mx-auto max-w-6xl px-4 py-20 grid gap-12 md:grid-cols-2 items-center">
          <div>
            ...
            <form className="mt-8 flex w-full max-w-lg items-center gap-2" id="cta">
            <input
              type="email"
              required
              placeholder="メールアドレス"
              ...
              />
              <button className="shrink-0 rounded-xl bg-gray-900 px-5 py-3 text-white hover:bg-black">
                無料で開始
              </button>
            </form>
            <p className="mt-3 text-xs text-gray-500">クレジットカード不要・30秒で完了</p>
          </div>
            ...
            <div className="rounded-2xl border shadow-sm overflow-hidden">
              ...
              <div className="p-4 md:p-6">
                <div className="flex items-center gap-3">
                  <input type="text" placeholder="タスクを追加" className="w-full rounded-lg border px-3 py-2 text-sm" />
                  <button className="rounded-lg bg-gray-900 px-3 py-2 text-sm text-white">追加</button>
                </div>
                <ul className="mt-4 space-y-3">
                  {["要件定義を確定","UIのワイヤー作成","バックエンドAPIのエンドポイント設計","E2Eテスト計画"].map((t, i)=> (
